...
class ProductProduct(models.Model):
    ...
    @api.multi
    def name_get(self):
        res = super(ProductProduct, self.with_context(customerinfo=False)).\
            name_get()
        return res
    ...
    def get_product_multiline_description_sale(self):
        ...
        if self._context.get('partner_id'):
            ...
            if customerinfo and customerinfo.product_name:
                name = "%s%s" % (customerinfo.product_code and "[%s]" % customerinfo.product_code or "", customerinfo.product_name)
        return name

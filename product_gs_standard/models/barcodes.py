...
class BarcodeNomenclature(models.Model):
    ...
    def check_encoding(self, barcode, encoding, pattern=None):
        if encoding in ('gs1', 'udi'):
            if re.match(r'^(01)[0-9]{14}(11[0-9]{6}|10\w*|17[0-9]{6}|17[0-9]{8})(10\w*|17[0-9]{6}|17[0-9]{8}|21\w*|240\w*)$', barcode) \
                    or re.match(r'^(01)[0-9]{14}(11[0-9]{6}|11[0-9]{8}|17[0-9]{6}|17[0-9]{8})(17[0-9]{6}|17[0-9]{8}|11[0-9]{6}|11[0-9]{8})(10\w*|21\w*|240\w*)$', barcode) \
    ...
    def match_pattern(self, barcode, pattern):
        ...
        if re.match(r'^(01)[0-9]{14}(11[0-9]{6}|10\w*|17[0-9]{6}|17[0-9]{8})(|17[0-9]{6}|17[0-9]{8}|10\w*|21\w*|240\w*)$', _bcde_n) \
            or re.match(r'^(01)[0-9]{14}(11[0-9]{6}|11[0-9]{8}|17[0-9]{6}|17[0-9]{8})(17[0-9]{6}|17[0-9]{8}|11[0-9]{6}|11[0-9]{8})(10\w*|21\w*|240\w*)$', barcode) \

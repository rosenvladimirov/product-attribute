...
class CompetitorInfo(models.Model):
    _name = "product.competitorinfo"
    _description = "Information about a product competitor"
    ...
    product_uom = fields.Many2one(
        'product.uom', 'competitor Unit of Measure',
    ...
    product_id = fields.Many2one(
        ...
        help="If not set, the competitor price will apply to all variants of this products.")
